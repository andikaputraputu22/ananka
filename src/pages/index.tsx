...
const AnankaMerdekaLanding = () => {
    ...
    const floatingIcons: FloatingIcon[] = [
        ...
        { Icon: Flag, color: 'text-red-400', delay: '3.5s' },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-950 relative overflow-hidden">
            ...
            {/* Floating 17-8 Numbers - repositioned to avoid overlap */}
            <div className="absolute inset-0 z-10 pointer-events-none">
                <div
                    className="absolute top-20 left-8 text-6xl md:text-8xl font-thin text-red-500/10 animate-pulse select-none"
                    style={{ animationDelay: '2s' }}
                >
                    17
                </div>
                <div
                    className="absolute bottom-32 right-8 text-6xl md:text-8xl font-thin text-red-500/10 animate-pulse select-none"
            ...
            {/* Subtle Indonesian batik-inspired pattern overlay - moved up in z-index */}
            <div className="absolute inset-0 opacity-5 pointer-events-none z-10">
                <div className="absolute top-16 left-16 w-24 h-24 border border-red-400 rounded-full"></div>
                <div className="absolute top-32 right-24 w-20 h-20 border border-white rounded-full"></div>
                <div className="absolute bottom-48 left-24 w-28 h-28 border border-red-400 rounded-full"></div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
                    ...
                    <div className={`text-center mb-8 transition-all duration-1500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        <div className="relative inline-block">
                            <h1 className="text-5xl md:text-7xl font-light bg-gradient-to-r from-red-400 via-white to-red-300 bg-clip-text text-transparent mb-2 tracking-widest">
                                ANANKA
                            </h1>
                    ...
                    <div className={`text-center transition-all duration-1500 delay-1200 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
